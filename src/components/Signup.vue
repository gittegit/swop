      ...
      <div class="columns is-centered">
        <div v-if="registrationCompleted" class="column is-8 is-narrow is-form">
          ...
          <div class="task-description">
            <p class="description has-text-centered">Wir haben Dir eine Mail an <strong>{{ username }}</strong> geschickt. Bitte bestätige Deine Registrierung indem Du auf den darin enthaltenden Link klickst.</p>
          </div>
          <div class="spacer"></div>
          <p class="has-text-centered is-white font-klein">Falls Du nicht automatisch weitergeleitet wirst, klicke bitte hier:</p>
